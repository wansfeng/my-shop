...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/assets/plugins/jquery-ztree/css/zTreeStyle/zTreeStyle.min.css"/>
    <link rel="stylesheet" href="${ctx}/static/assets/plugins/dropzone/dropzone.css"/>
    <link rel="stylesheet" href="${ctx}/static/assets/plugins/dropzone/min/basic.min.css"/>
    <link rel="stylesheet" href="${ctx}/static/assets/plugins/wangEditor/wangEditor.min.css">
</head>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="categoryName" class="form-control required" path="categoryName" placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbContent.tbContentCategory.name}" />
                                    </div>
                                </div>
                                <div class="form-group">
...
<script src="${ctx}/static/assets/plugins/jquery-ztree/js/jquery.ztree.core-3.5.min.js"></script>
<script src="${ctx}/static/assets/plugins/dropzone/min/dropzone.min.js"></script>
<script src="${ctx}/static/assets/plugins/wangEditor/wangEditor.min.js"></script>
...
<script>
    ...
    $(function () {
           ...
           App.initZTree("/content/category/tree/data", ["id"], function (nodes) {
               //获取选中的节点 显示在文本框内
               var nodes = nodes[0];
               $("#categoryId").val(nodes.id);
               $("#categoryName").val(nodes.name);
