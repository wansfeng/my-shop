...
<html>
<head>
    <title>我的商场 ｜ 内容管理</title>
    <jsp:include page="../includes/header.jsp"/>
    <link rel="stylesheet" href="${ctx}/static/assets/plugins/treeTable/themes/vsStyle/treeTable.min.css">
</head>
                                   ...
                                   <c:forEach items="${tbContentCategories}" var="tbContentCategory">
                                       <tr id="${tbContentCategory.id}" pId="${tbContentCategory.parent.id}">
                                           ...
                                           <td>
                                               ...
                                               <button type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle('/content/category/delete', '${tbContentCategory.id}','警告：该删除操作会将包括选中类目在内的全部子类目及属性类目的内容一并删除，请谨慎操作! 您还要继续吗')"><i class="fa fa-trash-o"></i>删除</button>
...
<script src="${ctx}/static/assets/plugins/treeTable/jquery.treeTable.min.js"></script>
