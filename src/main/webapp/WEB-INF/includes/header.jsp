...
<link rel="stylesheet" href="${ctx}/static/assets/plugins/iCheck/all.css">


<!-- DataTables -->
<link rel="stylesheet" href="${ctx}/static/assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
...
<link rel="stylesheet" href="${ctx}/static/assets/css/skins/_all-skins.min.css">